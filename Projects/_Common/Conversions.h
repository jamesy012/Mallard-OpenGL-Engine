...
//from https://pybullet.org/Bullet/phpBB3/viewtopic.php?t=11462
...
void bulletToTransform(Transform& a_To, btTransform& a_From) {
	a_To.setPosition(bulletToGlm(a_From.getOrigin()));
	a_To.setRotation(bulletToGlm(a_From.getRotation()));
}
